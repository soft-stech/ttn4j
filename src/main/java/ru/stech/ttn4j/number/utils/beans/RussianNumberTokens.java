...
public class RussianNumberTokens {
    ...
    static {
        ...
        TOKENS.put(new String("нуля".getBytes(), StandardCharsets.UTF_8), new Numeral("0", -1, false));
        TOKENS.put(new String("еденица".getBytes(), StandardCharsets.UTF_8), new Numeral("1", -1, false));
        TOKENS.put(new String("еденицы".getBytes(), StandardCharsets.UTF_8), new Numeral("1", -1, false));
        TOKENS.put(new String("едениц".getBytes(), StandardCharsets.UTF_8), new Numeral("1", -1, false));
        TOKENS.put(new String("двоек".getBytes(), StandardCharsets.UTF_8), new Numeral("2", -1, false));
        TOKENS.put(new String("двойки".getBytes(), StandardCharsets.UTF_8), new Numeral("2", -1, false));
        TOKENS.put(new String("троек".getBytes(), StandardCharsets.UTF_8), new Numeral("3", -1, false));
        TOKENS.put(new String("тройки".getBytes(), StandardCharsets.UTF_8), new Numeral("3", -1, false));
        TOKENS.put(new String("четверок".getBytes(), StandardCharsets.UTF_8), new Numeral("4", -1, false));
        TOKENS.put(new String("четверки".getBytes(), StandardCharsets.UTF_8), new Numeral("4", -1, false));
        TOKENS.put(new String("пятерок".getBytes(), StandardCharsets.UTF_8), new Numeral("5", -1, false));
        TOKENS.put(new String("пятерки".getBytes(), StandardCharsets.UTF_8), new Numeral("5", -1, false));
        TOKENS.put(new String("шестерок".getBytes(), StandardCharsets.UTF_8), new Numeral("6", -1, false));
        TOKENS.put(new String("шестерки".getBytes(), StandardCharsets.UTF_8), new Numeral("6", -1, false));
        TOKENS.put(new String("семерок".getBytes(), StandardCharsets.UTF_8), new Numeral("7", -1, false));
        TOKENS.put(new String("семерки".getBytes(), StandardCharsets.UTF_8), new Numeral("7", -1, false));
        TOKENS.put(new String("восьмерок".getBytes(), StandardCharsets.UTF_8), new Numeral("8", -1, false));
        TOKENS.put(new String("восьмерки".getBytes(), StandardCharsets.UTF_8), new Numeral("8", -1, false));
        TOKENS.put(new String("девяток".getBytes(), StandardCharsets.UTF_8), new Numeral("9", -1, false));
        TOKENS.put(new String("девятки".getBytes(), StandardCharsets.UTF_8), new Numeral("9", -1, false));
